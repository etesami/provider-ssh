...
The [provider-ssh](https://github.com/etesami/provider-ssh) repository can be
...
- [ ]  Code is licensed under the [Apache 2.0
  License](https://github.com/etesami/provider-ssh/blob/main/LICENSE)
...
- [ ]  Update
  [OWNERS.md](https://github.com/etesami/provider-ssh/blob/main/OWNERS.md)
...
- [ ]  Ensure `hack/boilerplate.go.txt` (used in Code generation) includes
  ...
  [https://github.com/etesami/provider-ssh/blob/main/hack/boilerplate.go.txt](https://github.com/etesami/provider-ssh/blob/main/hack/boilerplate.go.txt)
...
The [provider-ssh](https://github.com/etesami/provider-ssh)
...
- [ ] Create a [Crossplane
  ...
  configuration (see
  [package/crossplane.yaml)](https://github.com/etesami/provider-ssh/blob/main/package/crossplane.yaml)
...
- [ ] Utilize GitHub workflows from
  <https://github.com/etesami/provider-ssh/tree/main/.github/workflows>
...
- [ ] Enable Issues on your project and configure Issue sshs (examples at:
  [.github/ISSUE_TEMPLATE](https://github.com/etesami/provider-ssh/tree/master/.github/ISSUE_TEMPLATE))
- [ ] Create Pull Request SSHs: (example:
  [PULL_REQUEST_TEMPLATE.md](https://github.com/etesami/provider-ssh/blob/master/.github/PULL_REQUEST_TEMPLATE.md))
